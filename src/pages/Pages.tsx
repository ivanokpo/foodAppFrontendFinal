  ...
  return (
    <AnimatePresence exitBeforeEnter>
      <Routes location={location} key={location.pathname}>
        ...
        <Route
          path="/cookbook"
          element={<Cookbook backendUrl={backendUrl} />}
        />
        <Route path="/category" element={<Categories />} />
        <Route
          path="/recipes/category/:dishType"
          element={<CatResults backendUrl={backendUrl} />}
        />
        <Route
          path="/recipes/searched/:search"
          element={<Searched backendUrl={backendUrl} />}
        />
        <Route
          path="/recipes/:id"
          element={<Recipe backendUrl={backendUrl} />}
        />
      </Routes>
    </AnimatePresence>
  );
